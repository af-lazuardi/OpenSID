					...
					<div class="box box-primary">
						...
						<div class="box-body">
							...
							<div class="form-group">
								...
								<div class="col-sm-8">
									<input id="password" name="password" class="form-control input-sm required" type="password" placeholder="Password" value="<?=$user['password']?>"></input>
									<!-- <input id="password" name="password" class="form-control input-sm required" type="password" placeholder="Password" <?php if ($user): ?>value="<?=$user['password']?>"<?php endif ?> ></input> -->
								</div>
							</div>
							<div class="form-group">
