<?php class Keluarga_model extends CI_Model {
	...
	*/
	...
	{
		// from kpV19.04 $sql = "FROM tweb_biodata_penduduk u
	...
	public function list_data($o=0, $offset=0, $limit=500)
	{
		...
		$sql = "SELECT u.*, t.nama AS kepala_kk, t.nik, t.tag_id_card, t.sex, t.status_dasar, t.id as id_pend, (SELECT COUNT(nik) FROM tweb_biodata_penduduk WHERE no_kk = u.no_kk AND status_dasar = 1) AS jumlah_anggota, c.dusun, c.rw, c.rt";
